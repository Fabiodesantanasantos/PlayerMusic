...
const cedoOuTarde = {
    songName : 'Cedo Ou Tarde',
    artist : 'Nx Zero',
    file : 'Cedo_Ou_Tarde',
    liked: false
}
const daquiPraFrente = {
    songName : 'Daqui Pra Frente',
    artist : 'Nx Zero',
    file : 'Daqui_Pra_Frente',
    liked: false
}
const hojeOCeuAbriu = {
    songName : 'Hoje O Céu Abriu',
    artist : 'Nx Zero',
    file : 'Hoje_O_Ceu_Abriu',
    liked: false
}
let isPlaying = false
let isShuffle = false
let repeatOn = false
const originalPlaylist = JSON.parse(localStorage.getItem('playlist')) ?? [cedoOuTarde, daquiPraFrente, hojeOCeuAbriu]
